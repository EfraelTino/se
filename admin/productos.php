                    ...
                    while ($data = mysqli_fetch_assoc($query)) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="editar.php?id=<?php echo $data['id']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="editar_producto"><i class="fas fa-plus fa-sm text-white-50"></i> Editar</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
